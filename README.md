...
> 📖 **Also see:** [`docs/kitty-addon-for-oac.md`](docs/kitty-addon-for-oac.md) for the technical deep-dive into the Kitty addon architecture.
...
│   ├── install-opencode.sh
│   ├── README.md
│   └── WORKFLOW.md     # Split-screen workflow guide
...
└── docs/               # Full documentation archive
    ...
    ├── context.md
    ├── kitty-addon-for-oac.md
    ├── oac-system-analysis.md
    ├── open-agent-control.md
    ├── open-agent-control.html
    ├── open-agent-control-print.html
    ├── why-kitty-oac.md    # This document
    └── workflow-splitscreen.md
```
...
Despite the failure documented above, the Kitty configuration and scripts are functional:

```bash
# Install Kitty
cd scripts && ./install-kitty.sh

# Install OpenCode (YMMV)
cd ../opencode && ./install-opencode.sh
```

See [`docs/workflow-splitscreen.md`](docs/workflow-splitscreen.md) for the intended split-screen workflow.

---

## Related Documentation

- **[`docs/kitty-addon-for-oac.md`](docs/kitty-addon-for-oac.md)** — Technical deep-dive into the Kitty addon architecture
- [`docs/architecture-decisions.md`](docs/architecture-decisions.md) — Architecture decision records
- [`docs/workflow-splitscreen.md`](docs/workflow-splitscreen.md) — Split-screen workflow guide

---

*This repository is archived as a documentary artifact. The code works; the integration doesn't.*
